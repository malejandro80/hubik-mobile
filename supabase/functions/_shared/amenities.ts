// Amenity heuristics (RFC 010). Mirrors src/lib/amenities.ts, kept as a separate copy rather than
// a shared module - the RN bundle and these Deno edge functions don't share a module graph, same
// precedent as this repo's other client-vs-edge-function heuristic duplication (RFC 008's city
// matching).
