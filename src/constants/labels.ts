export const labels = {
  ...
  whatsapp: {
    ...
    add: 'Añadir WhatsApp',
    change: 'Cambiar WhatsApp',
    save: 'Guardar',
    remove: 'Quitar',
    cancel: 'Cancelar',
    placeholder: '+58 414 123 4567',
    hint: 'Lo verán los clientes interesados en sus propiedades.',
    invalid: 'Escriba el número con código de país, por ejemplo +58 414 123 4567.',
    saveError: 'No se pudo guardar. Inténtelo de nuevo.',
    inputA11y: 'Número de WhatsApp',
  },
  burgerMenu: {
    brandTitle: 'Hubik',
  ...
  propertyDetail: {
    ...
    whatsappMessage: (title: string) => `Hola, me interesa «${title}» que vi en Hubik.`,
    whatsappUnavailableTitle: 'No se pudo abrir WhatsApp',
    whatsappUnavailableMessage: 'Compruebe que WhatsApp esté instalado e inténtelo de nuevo.',
